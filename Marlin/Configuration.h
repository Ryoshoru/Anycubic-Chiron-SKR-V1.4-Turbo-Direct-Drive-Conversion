...
#define STRING_CONFIG_H_AUTHOR "(Rene Erler, Chiron Direct Drive V1.0)" // Who made the changes.
...
#define PREHEAT_1_TEMP_CHAMBER 35
#define PREHEAT_1_FAN_SPEED 255 * 0.5 // Value from 0 to 255
