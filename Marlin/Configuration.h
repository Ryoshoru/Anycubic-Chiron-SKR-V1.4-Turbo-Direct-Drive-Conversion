...
#define STRING_CONFIG_H_AUTHOR "(Rene Erler, Chiron Direct Drive V1.3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Anycubic Chiron DD"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "aecb9887-c477-4f96-ba42-a952761cbdcb"
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 19.1201f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.2932f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0878f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1373f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
  ...
  #define MPC_TUNING_POS { X_CENTER, Y_CENTER, 0.24f } // (mm) M306 Autotuning position, ideally bed center at first layer height.
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE { 125, 125, 25, 70 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 31, 7, -2.56 }
...
#define PREHEAT_3_FAN_SPEED 125 // Value from 0 to 255
