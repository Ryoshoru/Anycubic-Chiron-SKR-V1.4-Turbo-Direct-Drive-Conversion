...
#define STRING_CONFIG_H_AUTHOR "(Rene Erler, Chiron Direct Drive V1.1)" // Who made the changes.
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 700, 100, 10000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -1, 19, -0.46 }
