 ...
 */
#define FAN_MIN_PWM 11
//#define FAN_MAX_PWM 170
...
#define COOLER_AUTO_FAN_PIN P2_03
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  40, 40 }, { 360,  40 }, { 360, 360 }, { 40, 360 } }
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  19.39          // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  19.39         // (Hz) The default dominant resonant frequency on the Y axis.
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    130  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
